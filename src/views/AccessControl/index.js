...
import ModalControlAccessRegister from '../../components/ComponentModal/ModalControlAccessRegister';
    ...
    return (
        <>
            <div>
                ...
                <ModalControlAccessRegister openModal={openModal} setOpenModal={setOpenModal} />
            </div>
        </>
    );
}
